...
BEGIN_MESSAGE_MAP(CConfigDlg, CDialogEx)
	ON_BN_CLICKED(IDC_MFCBUTTON2, &CConfigDlg::OnBnClickedMfcbutton2)
	ON_BN_CLICKED(IDC_MFCBUTTON1, &CConfigDlg::OnBnClickedMfcbutton1)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
void CConfigDlg::OnBnClickedMfcbutton1()
{
	// TODO: 在此添加控件通知处理程序代码
	TCHAR szBuf_path[PATH_LENGTH] = { 0 };
	WORD nBuf_Key[2];
...
void CConfigDlg::OnBnClickedMfcbutton2()
{
	// TODO: 在此添加控件通知处理程序代码
	CDialog::OnCancel();
}
